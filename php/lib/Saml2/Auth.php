...
class Auth
{
    ...
    public function processResponse($requestId = null)
    {
        ...
        if (isset($_POST['SAMLResponse'])) {
			...
			// ADDED THIS TO ALLOW MONITORING OF SALESFORCE SAML RESPONSE - m.
			update_option( 'most_recent_saml_response_time', date( "F j, Y, g:i a" ) . " GMT", false );

            if ($response->isValid($requestId)) {
                $this->_attributes = $response->getAttributes();

				// ADDED THIS TO ALLOW MONITORING OF SALESFORCE SAML RESPONSE - m.
				update_option( 'most_recent_saml_response_attributes', print_r( $this->_attributes, 1 ), false );
				...
				// ADDED THIS TO ALLOW MONITORING OF SALESFORCE SAML RESPONSE - m.
				update_option( 'most_recent_saml_response_error', print_r( $this->_lastError, 1 ), false );
